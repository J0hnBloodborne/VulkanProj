...
inline void HelloTriangleApplication::createRenderPass() {
...
inline void HelloTriangleApplication::createFramebuffers() {
...
inline void HelloTriangleApplication::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
